...
<script src="style/jquery/jquery-1.5.min.js" type="text/javascript" > </script>
...
<script>
						...
						jQuery(".login").submit(function(e){
								...
								$.ajax({
									...
									{
									//	alert(response);
									$.jGrowl("You Have Already Taken This Exam", { header: 'Access Denied' });
...
<form action="" method="post" name="form1" class="login">
  ...
  <input name="user" type="text" class="username" required/> <br/>
...
<div class="footertext">
 CBT (Computer Based Test) &copy; <?php echo date("Y"); ?>
</div>
 </div>
 <div class="col-md-3">
 </div>
